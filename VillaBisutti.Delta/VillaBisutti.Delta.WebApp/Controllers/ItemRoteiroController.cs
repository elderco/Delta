...
namespace VillaBisutti.Delta.WebApp.Controllers
{
    public class ItemRoteiroController : Controller
    {
		...
		public ActionResult Create([Bind(Include = "Id,Titulo,Inicio.Hora,Inicio.Minuto,Importante,Observacao,RoteiroPadraoId,RoteiroId")] model.ItemRoteiro itemroteiro)
        {
