...
namespace VillaBisutti.Delta.WebApp.Controllers
{
    public class TipoItemOutrosItensController : Controller
    {
		...
		public ActionResult Create([Bind(Include = "Id,Nome,PadraoAniversario,PadraoBarmitzva,PadraoBatmitzva,PadraoCasamento,PadraoCorporativo,PadraoDebutante,PadraoOutro")] model.TipoItemOutrosItens tipoitemoutrositens)
        {
